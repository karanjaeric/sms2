 ...
 * @author ekaranja
 */
@WebServlet(name = "InventorySearch", urlPatterns = {"/inventorySearch"})
public class InventorySearch extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Item item = inventoryBean.findByItemCode(code);

            response.getWriter().write(JsonUtil.convertObjectsToJson(item));
        }
    }
